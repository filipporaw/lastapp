...
/**
 * Load CoverLetterControlBar client side since it uses usePDF, which is a web specific API
 */
export const CoverLetterControlBarCSR = dynamic(
  () => Promise.resolve(CoverLetterControlBar),
  {
    ssr: false,
  }
);
